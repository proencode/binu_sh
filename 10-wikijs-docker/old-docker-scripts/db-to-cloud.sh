...
#-- kaosorder2	kaoslog		backup/kaosdb	kaosorder	kaosngc		ok/""	kaosorder2 (카오스)
#-- gate242	swlog		backup/gatedb	gate242		swlibgc		ok/""	gateroot (서원)
#-- wiki	-not use-	backup/wikidb	wiki.js		yosjgc		ok/""	wiki (wiki.js)
#--
